...
static final function bool MeetsSquadSizeRequirement()
{
	...
	return CurrentSquadSize < class'X2StrategyGameRulesetDataStructures'.static.GetMaxSoldiersAllowedOnMission(MissionState);
}
